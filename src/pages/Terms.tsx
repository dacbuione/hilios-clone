      ...
      <div className="container-custom">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you") and HiliosAI ("Company", "we", "us", or "our"), concerning your access to and use of the HiliosAI website, AI agent services, and related applications (collectively, the "Services").
            </p>
            <p>
              You agree that by accessing the Services, you have read, understood, and agree to be bound by all of these Terms of Use. If you do not agree with all of these Terms of Use, then you are expressly prohibited from using the Services and must discontinue use immediately.
            </p>

            <h2 className="text-2xl font-bold mt-12 mb-4">2. Intellectual Property Rights</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">3. User Representations</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">4. User Registration</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">5. Prohibited Activities</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">6. User Generated Contributions</h2>
            <p>
            ...
            <p>
              Any Contribution you transmit to the Services will be treated as non-confidential and non-proprietary. When you create or make available any Contributions, you thereby represent and warrant that:
            </p>
            <ul className="list-disc pl-6 mb-6">
              <li>The creation, distribution, transmission, public display, or performance, and the accessing, downloading, or copying of your Contributions do not and will not infringe the proprietary rights, including but not limited to the copyright, patent, trademark, trade secret, or moral rights of any third party.</li>
              <li>You are the creator and owner of or have the necessary licenses, rights, consents, releases, and permissions to use and to authorize us, the Services, and other users of the Services to use your Contributions in any manner contemplated by the Services and these Terms of Use.</li>
              <li>Your Contributions are not false, inaccurate, or misleading.</li>
              <li>Your Contributions are not unsolicited or unauthorized advertising, promotional materials, pyramid schemes, chain letters, spam, mass mailings, or other forms of solicitation.</li>
              <li>Your Contributions do not violate any applicable law, regulation, or rule.</li>
            </ul>

            <h2 className="text-2xl font-bold mt-12 mb-4">7. Contribution License</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">8. Services Management</h2>
            <p>
              We reserve the right, but not the obligation, to:
            </p>
            <ul className="list-disc pl-6 mb-6">
              <li>Monitor the Services for violations of these Terms of Use.</li>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">9. Term and Termination</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">10. Modifications and Interruptions</h2>
            <p>
            ...
            <p>
              These Terms of Use and your use of the Services are governed by and construed in accordance with the laws of Vietnam applicable to agreements made and to be entirely performed within Vietnam, without regard to its conflict of law principles.
            </p>

            <h2 className="text-2xl font-bold mt-12 mb-4">12. Dispute Resolution</h2>
            <p>
              Any legal action of whatever nature brought by either you or us shall be commenced or prosecuted in the courts located in Ho Chi Minh City, Vietnam, and you and we hereby consent to, and waive all defenses of lack of personal jurisdiction and forum non conveniens with respect to venue and jurisdiction in such courts.
            </p>

            <h2 className="text-2xl font-bold mt-12 mb-4">13. Corrections</h2>
            <p>
              There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.
            </p>

            <h2 className="text-2xl font-bold mt-12 mb-4">14. Contact Us</h2>
            <p>
              In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:
            </p>
            <p className="mt-4">
              <strong>HiliosAI</strong><br />
              72nd Floor, Landmark 81<br />
              Vinhomes Central Park, 720A Dien Bien Phu Street<br />
              Ward 22, Binh Thanh District<br />
              Ho Chi Minh City, Vietnam<br />
              <br />
              Email: legal@hilios.ai<br />
              Phone: (+84) 03 7645 5022
            </p>
          </div>
        </div>
      </div>
