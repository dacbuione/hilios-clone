      ...
      <div className="container-custom">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              HiliosAI ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our AI agent services, website, and related applications (collectively, the "Services").
            </p>
            <p>
            ...
            <h3 className="text-xl font-bold mt-8 mb-3">2.1 Personal Information</h3>
            <p>
            ...
            <h3 className="text-xl font-bold mt-8 mb-3">2.2 Usage Data</h3>
            <p>
            ...
            <h3 className="text-xl font-bold mt-8 mb-3">2.3 AI Interaction Data</h3>
            <p>
              When you interact with our AI agents, we collect and process:
            </p>
            <ul className="list-disc pl-6 mb-6">
              <li>Conversation history and content</li>
              <li>User queries and AI responses</li>
              <li>Performance metrics and interaction patterns</li>
              <li>Feedback provided about AI interactions</li>
            </ul>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">4. How We Share Your Information</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">7. Your Privacy Rights</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">8. Changes to This Privacy Policy</h2>
            <p>
